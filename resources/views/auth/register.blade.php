<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-jet-label for="phones" value="{{ __('phones') }}" />
                <x-jet-input id="phones" class="block mt-1 w-full" type="text" name="phones" :value="old('phones')" required autofocus autocomplete="phones" />
            </div>
